/*
 * Jeu d'icônes SVG (trait 24×24, style Lucide — licence ISC).
 * Les contenus issus de l'ancien site utilisent des noms Font Awesome : ils sont
 * convertis via ALIASES, ce qui permet de continuer à saisir ces noms dans l'admin.
 */
export const ICONS: Record<string, string> = {
  ...
  shield: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M12 2v20" opacity=".45"/>',
  ...
  'door-open':
    '<path d="M13 4h3a2 2 0 0 1 2 2v14"/><path d="M2 20h3"/><path d="M13 20h9"/><path d="M10 12v.01"/><path d="M13 4.56v16.16a.6.6 0 0 1-.78.57L5 19V5.02a1 1 0 0 1 .79-.98l6-1.26a1 1 0 0 1 1.21.98z"/>',
  factory:
  ...
  city: '<path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18"/><path d="M6 12H4a2 2 0 0 0-2 2v8h20v-8a2 2 0 0 0-2-2h-2"/><path d="M10 6h4M10 10h4M10 14h4M10 18h4"/>',
  ...
  'rotate-3d':
    '<path d="M16.47 9.53A10.07 10.07 0 0 0 12 9c-4.97 0-9 1.79-9 4s4.03 4 9 4"/><path d="m9 14 3 3-3 3"/><path d="M12 4v13" opacity=".4"/><path d="M17 16.5c2.4-.7 4-1.9 4-3.5 0-.8-.4-1.5-1-2.1"/>',
  ...
  hammer:
    '<path d="m15 12-8.37 8.37a2.12 2.12 0 1 1-3-3L12 9"/><path d="M17.64 15 22 10.64"/><path d="m20.91 11.7-1.25-1.25c-.6-.6-.93-1.4-.93-2.25v-.86L16.01 4.6a5.56 5.56 0 0 0-3.94-1.64H9l.92.82A6.18 6.18 0 0 1 12 8.4v1.56l2 2h2.47l2.26 1.91"/>',
  spray:
    '<path d="M3 3h.01M7 5h.01M11 7h.01M3 7h.01M7 9h.01M3 11h.01"/><rect x="15" y="5" width="4" height="4"/><path d="m19 9 2 2v10c0 .6-.4 1-1 1h-6c-.6 0-1-.4-1-1V11l2-2"/><path d="m13 14 8-2M13 19l8-2"/>',
  ...
  school: '<path d="m4 6 8-4 8 4"/><path d="m18 10 4 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-8l4-2"/><path d="M14 22v-4a2 2 0 0 0-4 0v4"/><path d="M18 5v17M6 5v17"/><circle cx="12" cy="9" r="2"/>',
  ...
  'arrows-h': '<path d="m18 8 4 4-4 4M6 8l-4 4 4 4M2 12h20"/>',
  'arrows-v': '<path d="m8 18 4 4 4-4M8 6l4-4 4 4M12 2v20"/>',
  pointer:
  ...
  frame: '<rect x="3" y="3" width="18" height="18" rx="1"/><rect x="7" y="7" width="10" height="14"/>',
  bars: '<path d="M4 3v18M9 3v18M15 3v18M20 3v18M2 8h20M2 16h20"/>',
  cookie:
    '<path d="M12 2a10 10 0 1 0 10 10 4 4 0 0 1-5-5 4 4 0 0 1-5-5"/><path d="M8.5 8.5v.01M16 15.5v.01M12 12v.01M11 17v.01M7 14v.01"/>',
  ...
  'x-logo': '<path d="M4 4h4.3L20 20h-4.3z"/><path d="M4 20l6.8-7.4M20 4l-6.8 7.4"/>',
  facebook: '<path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>',
  instagram: '<rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><path d="M17.5 6.5h.01"/>',
};

/** Correspondance noms Font Awesome (ancien site) → icônes du jeu. */
...
export function iconPaths(name?: string | null): string {
  if (!name) return ICONS['hexagon'];
  const key = ICONS[name] ? name : ALIASES[name];
  return (key && ICONS[key]) || ICONS['hexagon'];
}
